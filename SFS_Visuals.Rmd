...
structureFire_sf_address <-
  structureFire_sf %>%
  unite(address, c('Address Number', 'Street Prefix', 'Street Name', 'Street Type', 'Apt Room'), sep = " ", remove = TRUE, na.rm=TRUE)

#Taking out duplicate incident numbers
structureFire_sf_addressU <- 
    structureFire_sf_address[!duplicated(structureFire_sf_address$`Incident Number`),]

#Taking out spots with geometry outside the US
structureFire_sf_addressUC <- 
    structureFire_sf_addressU[acsTractsPHL.2020,]
