...
OPA_addressSample <- OPA_address[1:100,]



```
Combine OPA to panel
...
panel_OPAFire <- full_join(panelOPA, count.panel, by=c("address", "quarter")) # Join
...
panel_OPAFire <- left_join(panelOPA, count.panel, by=c("address", "quarter"))%>% # Join
  panel_OPAFire$n[is.na(panel_OPAFire$n)] <- 0
